...
@Component({
  selector: 'app-add-scs-serviccharge',
  templateUrl: './add-scs-serviccharge.component.html',
  styleUrls: ['./add-scs-serviccharge.component.scss']
})
export class AddScsServicchargeComponent implements OnInit {
