...
import { AddAppInterfaceComponent } from './add-app-interface/add-app-interface.component';
...
export class AppInterfaceComponent implements OnInit {
  ...
  getGeneralInterfaces(){
    ...
    this.controlService.getGeneralInterface('APPINTERFACE').subscribe({
      next:(res)=>{
  ...
  addGeneralInterface(){
    ...
    let modalRef = this.modalService.open(AddAppInterfaceComponent,  {size:'lg',backdrop:'static'})
