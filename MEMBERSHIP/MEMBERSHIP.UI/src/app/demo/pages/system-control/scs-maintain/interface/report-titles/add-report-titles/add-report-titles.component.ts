...
@Component({
  selector: 'app-add-report-titles',
  templateUrl: './add-report-titles.component.html',
  styleUrls: ['./add-report-titles.component.scss']
})
export class AddReportTitlesComponent implements OnInit {
