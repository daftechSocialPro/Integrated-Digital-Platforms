...
namespace IntegratedInfrustructure.Migrations
{
    ...
    [Migration("20230905103345_companyprofiledescription")]
    partial class companyprofiledescription
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("IntegratedInfrustructure.Model.Vacancy.ApplcantDocuments", b =>
                {
                    ...
                    b.Property<Guid>("VacancyDocumentId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("IntegratedInfrustructure.Model.Vacancy.Vacancy", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("IntegratedInfrustructure.Model.Vacancy.ApplcantDocuments", b =>
                {
                    ...
                    b.HasOne("IntegratedInfrustructure.Model.Vacancy.VacancyDocuments", "VacancyDocument")
                        .WithMany()
                        .HasForeignKey("VacancyDocumentId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.Navigation("Applicant");

                    b.Navigation("VacancyDocument");
                });
            ...
            modelBuilder.Entity("IntegratedInfrustructure.Model.Vacancy.Applicant", b =>
                {
                    ...
                    b.HasOne("IntegratedInfrustructure.Model.Vacancy.Vacancy", "Vacancy")
                        .WithMany()
