...
namespace IntegratedDigitalAPI.Services.PM.ProgressReport
{
    public class ProgressReportService : IProgressReportService
    {
        ...
        public async Task<PlanReportDetailDto> StructureReportByProgram(string BudgetYear, string ProgramId, string ReportBy)
        {
            ...
            try
            {
                ...
                if (BudgetYear != null)
                {
                    ...
                    var StrucsinProg = _dBContext.Projects.Select(x => x.DepartmentId).Distinct();
                    var Structures = _dBContext.Departments.Where(x => StrucsinProg.Contains(x.Id)).ToList();
                    foreach (var stItems in Structures)
                    {
                        ...
                        var plansinStruc = _dBContext.Projects
                            .Include(x => x.Tasks).ThenInclude(x => x.ActivitiesParents).ThenInclude(x => x.Activities)
                            .Include(x => x.Tasks).ThenInclude(x => x.Activities)
                        ...
                        foreach (var Plitems in plansinStruc)
                        {
                            ...
                            StrPlan.PlanName = Plitems.ProjectName;
                            if (Plitems.HasTask)
                            {
                                StrPlan.PlanTasks = new List<PlanTask>();
                                foreach (var taskPl in Plitems.Tasks.OrderBy(x => x.CreatedDate))
                                {
                                    ...
                                    if (taskPl.HasActivityParent)
                                    {
                                        ...
                                        var ActInTask = taskPl.ActivitiesParents.ToList().OrderBy(x => x.CreatedDate);
                                        foreach (var parentAct in ActInTask)
                                        {
                                            ...
                                            if (parentAct.HasActivity)
                                            {
                                                ...
                                                foreach (var subActs in parentAct.Activities.OrderBy(x => x.CreatedDate))
                                                {
                                                    ...
                                                    if (actSub != null)
                                                    {
                                                        ...
                                                        actSub.UnitOfMeasurment = subActs.Indicator;
                                            ...
                                            else
                                            {
                                                ...
                                                if (PActTarDiv != null)
                                                {
                                                    ...
                                                    taskActivity.UnitOfMeasurment = PActTarDiv.Indicator;
                                    ...
                                    else
                                    {
                                        ...
                                        if (tasTarDiv != null)
                                        {
                                            ...
                                            pT.UnitOfMeasurment = tasTarDiv.Indicator;
                            ...
                            else
                            {
                                ...
                                if (targetDiv != null)
                                {
                                    ...
                                    StrPlan.UnitOfMeasurment = targetDiv.Indicator;
            ...
            try
            {
                ...
                foreach (var activity in activities)
                {
                    ...
                    if (Pocu != null)
                    {
                        ...
                        plns.UnitOfMeasurment = Pocu.Indicator;
                        ...
                        foreach (var taskItems in Taskes)
                        {
                                ...
                                foreach (var actparent in taskItems.ActivitiesParents)
                                {
                                    ...
                                    if (actparent.Activities != null)
                                    {
                                        ...
                                        foreach (var ActItems in actparent.Activities.Where(x => x.ActivityTargetDivisions != null))
                                        {
                                            ...
                                            lst.UnitOfMeasurment = ActItems.Indicator;
                                    ...
                                    else if (actparent.Activities.Any() && actparent.Activities.FirstOrDefault().targetDivision != null)
                                    {
                                        ...
                                        if (Pocu != null)
                                        {
                                            ...
                                            actparentlst.UnitOfMeasurment = Pocu.Indicator;
                            ...
                            else if (taskItems.Activities.Any() && taskItems.Activities.FirstOrDefault().ActivityTargetDivisions != null)
                            {
                                ...
                                if (Acti != null)
                                {
                                    ...
                                    taskLst.UnitOfMeasurment = Acti.Indicator;
        ...
        public async Task<List<ActivityViewDto>> GetActivityByLocation(string BugetYear, Guid LocationId)
        {
            ...
            List<ActivityViewDto> assignedActivities =
                await (from e in _dBContext.Activities
                       ...
                       .Where(x => x.ActivityLocations.Select(x=>x.ActivityId).Contains(LocationId)&&x.ShouldStat >= budgetYearStart &&x.ShouldEnd <= budgetYearEnd)
            ...
            try
            {
                ...
                if (filterationCriteria.actParentId != Guid.Empty)
                {
                    ...
                    foreach (var items in allActivities)
                    {
                        ...
                        if (items.ProjectTeamId != null)
                        {
                            commites = _dBContext.ProjectTeams.Single(x => x.Id == items.ProjectTeamId).Employees.Select(x => x.EmployeeId).ToList();
                        }
                ...
                else if (filterationCriteria.planId != Guid.Empty)
                {
                    ...
                    List<IntegratedInfrustructure.Models.PM.Activity> actes = new List<IntegratedInfrustructure.Models.PM.Activity>();
                    var plan = _dBContext.Projects.Find(filterationCriteria.planId);
                    ...
                    foreach (var plansItems in allPlans)
                    {
                            ...
                            foreach (var taskItems in plansItems.Tasks)
                            {
                                    ...
                                    foreach (var actparentItems in taskItems.ActivitiesParents)
                                    {
                                        ...
                                        else if (actparentItems.Activities.Any() && actparentItems.Activities.FirstOrDefault().targetDivision != null)
                                        {
                                            ...
                                            if (TaskOcs != null)
                                            {
                                                ...
                                                actparent.UnitOfMeasurment = TaskOcs.Indicator;
                                ...
                                else if (taskItems.Activities.Any() && taskItems.Activities.FirstOrDefault().ActivityTargetDivisions.Any())
                                {
                                    ...
                                    if (TaskOcs != null)
                                    {
                                        ...
                                        taskLst.UnitOfMeasurment = TaskOcs.Indicator;
                        ...
                        else if (plansItems.Activities.Any() && plansItems.Activities.FirstOrDefault().ActivityTargetDivisions.Any())
                        {
                            ...
                            if (PlanDivOcs != null)
                            {
                                ...
                                plns.UnitOfMeasurment = PlanDivOcs.Indicator;
            ...
            try
            {
                ...
                if (filterationCriteria.structureId != null)
                {
                    ...
                    var ActualWorked = _dBContext.ActivityProgresses
                        ...
                        .Include(x => x.Activity).ThenInclude(x => x.Task).ThenInclude(x => x.Project)
                        .Include(x => x.Quarter)

                        .Where(x => true &&


                   (x.Activity.ActivityParentId != null ? (x.Activity.ActivityParent.Task.Project.DepartmentId) : (x.Activity.TaskId != null ? x.Activity.Task.Project.DepartmentId : x.Activity.Plan.DepartmentId))
                == filterationCriteria.structureId).ToList();
                    ...
                    else if (filterationCriteria.filterbyId == 2)
                    {
                        ...
                        int fromMonth = month;
                        ActualWorked = ActualWorked.Where(x => x.CreatedDate.Month == fromMonth).ToList();
                    }
                    else if (filterationCriteria.filterbyId == 3)
                    {
                        ...
                        DateTime FromDateG = Convert.ToDateTime(fromDate);
                        string[] toDate = filterationCriteria.ToDate.Split(new string[] { "/" }, StringSplitOptions.RemoveEmptyEntries);
                        var ToDateG = Convert.ToDateTime(toDate);
                        ActualWorked = ActualWorked.Where(x => x.CreatedDate.Date >= FromDateG.Date && x.CreatedDate.Date <= ToDateG.Date).ToList();
                    }
                    ...
                    foreach (var items in ActualWorked)
                    {
                        ...
                        pp.ReportDate = items.CreatedDate.ToString();
                        ...
                        if (items.Activity.ActivityParentId != null)
                        {
                            ...
                            pp.PlanName = items.Activity.ActivityParent.Task.Project.ProjectName;
                            pp.ProgramName = items.Activity.ActivityParent.Task.Project.ProjectName;
                        }
                        else if (items.Activity.TaskId != null)
                        {
                            pp.TaskName = items.Activity.Task.TaskDescription;
                            pp.PlanName = items.Activity.Task.Project.ProjectName;
                            pp.ProgramName = items.Activity.Task.Project.ProjectName;
                        }
                        else
                        {
                            pp.TaskName = "--------";
                            pp.PlanName = items.Activity.Plan.ProjectName;
                            pp.ProgramName = items.Activity.Plan.ProjectName;
                        }
        ...
        public async Task<List<ActivityProgressViewModel>> GetActivityProgress(Guid? activityId)
        {
            ...
            try
            {
                ...
                var allProgress = await
                     ...
                     Include(x => x.ProgressAttachments).Where(x => x.ActivityId == activityId).OrderBy(x => x.CreatedDate)
                     .Select(progressRow => new ActivityProgressViewModel
                     {
                         ...
                         CreatedDateTime = progressRow.CreatedDate,
                         ProgressAttachments = progressRow.ProgressAttachments.ToList()
        ...
        public async Task<List<EstimatedCostDto>> GetEstimatedCost(Guid structureId, int budegtYear)
        {
            ...
            var plans = await _dBContext.Projects
            ...
            foreach (var item in plans)
            {
                ...
                {
                    estimatedCost.Description = item.ProjectName;
        ...
        public class ActivityProgressViewModel
        {
            ...
            public IntegratedInfrustructure.Models.PM.Activity Activity { get; set; }
            ...
            public EmployeeList EmployeeValue { get; set; }
        ...
        public float GetContribution(Guid structureId, float weight, Guid budetyearId)
        {
            ...
            var Plans = _dBContext.Projects
                ...
                .Where(x => x.DepartmentId == structureId).ToList();
        ...
        public float GetContribution2(Guid structureId, float weight, Guid budetyearId)
        {
            float performance = 0;
            float contribution = 0;
            float Progress = 0;
